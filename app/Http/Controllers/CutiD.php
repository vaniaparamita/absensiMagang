...
class CutiD extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        return view('AdminDepartemen.pengajuancuti2', compact('data'));
    ...
    //     }
      $data->save();
      return redirect()->route('cutidiajukan3.index')->with('cuti_success','Berhasil Mengubah Pengajuan Cuti!');
