      ...
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-12" style="background:white">
            ...
            <br />
            @foreach($data as $d)
            <form action="{{ route('detailizin.update', $d->id) }}" method="post" enctype="multipart/form-data">
			{{ csrf_field() }}
			{{ method_field('PUT') }}
					...
					<div class="form-group">
					  ...
					  <a class="btn btn-danger" href="{{route('detailizin.index')}}" role="button">Batalkan</a>
					</div>
				</form>
				@endforeach
            <br />
